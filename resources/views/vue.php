...
<body>
  ...
  <nav class="navbar navbar-default">
    <div class="container-fluid">
      <a class="navbar-brand"><i class="glyphicon glyphicon-bullhorn"></i> Belajar Vue JS</a>
    </div>
  </nav>
  ...
  <div class="container" id="app">
    ...
    <div class="col-sm-6">
      <div class="list-group">
        <a href="#" class="list-group-item" v-for="(event, index) in events" @click.prevent="editEvent(event)">
